...
# ----------------------------------------------------
# Plot projection of the neutral hydrogen number density,
# and temperature
# ----------------------------------------------------
...
project_kwargs = {"resolution": 1000, "parallel": True}
...
def plot_result(filename):
    ...
    cutoff = int(4 / (128 + 8) * project_kwargs["resolution"])

    mass_map = project_gas(data, project="masses", **project_kwargs)
    ...
    mass_weighted_HI_map = project_gas(data, project="mXHI", **project_kwargs)
    mass_weighted_temperature_map = project_gas(data, project="mT", **project_kwargs)
    ...
    figname = filename[:-5] + "-projection.png"
