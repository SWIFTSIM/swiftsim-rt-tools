...
double cosmo_get_comoving_volume(double vol_p, double a) {
  return vol_p / (a * a * a);
}

double cosmo_get_physical_volume(double vol_c, double a) {
  return vol_c * a * a * a;
}

double cosmo_get_comoving_radiative_temperature(double T_p, double a) {
  return T_p * a;
}

double cosmo_get_physical_radiative_temperature(double T_c, double a) {
  return T_c / a;
}
