...
for i, sim in enumerate(["av", "min", "max"]):
    ...
    ax1.semilogy(
        Time_Myr, Temperature, label=sim + " density", c=colors[i], **plotkwargs
    )
