...
void grackle_checks_density_sum(float density,
  ...
  double dens_sum = 0.;
  if (grackle_fields->HI_density != NULL)
    dens_sum += grackle_fields->HI_density[0];
  if (grackle_fields->HII_density != NULL)
    dens_sum += grackle_fields->HII_density[0];
  if (grackle_fields->HeI_density != NULL)
    dens_sum += grackle_fields->HeI_density[0];
  if (grackle_fields->HeII_density != NULL)
    dens_sum += grackle_fields->HeII_density[0];
  if (grackle_fields->HeIII_density != NULL)
    dens_sum += grackle_fields->HeIII_density[0];
  if (grackle_fields->H2I_density != NULL)
    dens_sum += grackle_fields->H2I_density[0];
  if (grackle_fields->H2II_density != NULL)
    dens_sum += grackle_fields->H2II_density[0];
  if (grackle_fields->DI_density != NULL)
    dens_sum += grackle_fields->DI_density[0];
  if (grackle_fields->DII_density != NULL)
    dens_sum += grackle_fields->DII_density[0];
  if (grackle_fields->HDI_density != NULL)
    dens_sum += grackle_fields->HDI_density[0];
