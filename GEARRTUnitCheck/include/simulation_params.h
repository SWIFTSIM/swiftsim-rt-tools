...
struct simulation_params {
  ...
  /*! reduced speed of light factor in internal units (units in which simulation
   * will be run) */
  float fc;

  /*! reduced speed of light in internal units (units in which simulation will
   * be run) */
  float c_reduced;
  ...
  /*! Expected density average in simulation in internal units (units in which
   * simulation will be run) */
  float density_average;

  /*! Expected min for density in internal units (units in which simulation will
   * be run) */
  float density_min;

  /*! Expected max for density in internal units (units in which simulation will
   * be run) */
  float density_max;

  /*! Simulation box size in internal units (units in which simulation will be
   * run) */
  float boxsize;

  /*! Estimate for particle smoothing length in internal units (units in which
   * simulation will be run) */
